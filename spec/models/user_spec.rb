...
describe User do
  ...
  describe "when name is not present" do
	...
	describe "when email format is not valid" do
		var=%w[user@foo,com user_at_foo.org example.user@foo.
                     foo@bar_baz.com foo@bar+baz.com]
        it "should be invalid" do
			var.each do |invalid_Address|
	...
	describe "when email format is valid" do
		var=%w[user@foo.COM A_US-ER@f.b.org frst.lst@foo.jp a+b@baz.cn]
		it "should be valid" do
			var.each do |valid_address|
